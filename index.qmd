...
# Your journey<br>[from data science to animated web graphics]{style="font-size: 65%"} {#section-silver
  background-video="/assets/backgrounds/WonderfulWizardWaterfall_Animated_Day.mp4"
...
## Hello! {
  background-image="/assets/backgrounds/WonderfulWizardWaterfall_Original_Day.jpg"
...
I'm James, a **data journalist** at [**360info**](https://360info.org)
...
:::{.small}
Adding a stylesheet to a Quarto or RMarkdown
...
I've gone research + data science -> communication -> data journalism
...
If you have Quarto, you're ready to go!
...
::: {.columns}
::: {.column .has-table width="35%"}

```{ojs}
viewof selectedCities = Inputs.table(transpose(aus_pops), {
  required: false
})
```
:::
...
```{ojs}
width > 700 ? svg`${barPlot}` : svg`${vertBarPlot}`
```
...
If only we had **more control** over what was drawn...

# The big boss<br>[Drawing graphics directly in Quarto]{style="font-size: 65%"} {
...
To do transitions, we need something that can **transition between the two**
...
But reactivity is really popular these days! All of these are reactive:
...
## [~~Reactivity~~]{style="opacity: 0.5;"} Declarative graphics: everyone's doing them {
  background-image="/assets/backgrounds/VampireMansion_Cliff_Night.jpg"
  background-opacity="0.99"
  background-color="#240d07"}
...
## Is Svelte the answer? {
  background-image="/assets/backgrounds/VampireMansion_Cliff_Night.jpg"
  background-opacity="0.9"
  background-color="#240d07"}

Created by Rich Harris (former Guardian, New York Times graphics)

I got hooked after a [**blog post**](https://connorrothschild.github.io/v4/post/svelte-and-d3) by Connor Rothschild  
(he has an [**updated post**](https://connorrothschild.github.io/v4/viz) now!)

Svelte has tools for turning data into **changing graphics**, like transitions
...
::: {.columns}
::: {.column width="40%"}
![["Stop doing math" meme with JavaScript](https://www.reddit.com/r/ProgrammerHumor/comments/1adzvbs/stopdoingjavascript/)](/assets/stop-doing-js-meme.jpg)
:::
::: {.column width="60%"}
...
Files, modules, packages, configs... yuck!
:::
:::
...
I want the declarative and reactive power of a web framework like Svelte

But I still want to work in Quarto most of the time

Adding a Svelte chart to my Quarto doc should be as easy as using Svelte in the browser sandbox
...
**Posit** for accepting my talk

**Andrew Bray** for letting me pinch a Closeread example

**Czepuku** for letting me use their sweet backgrounds under licence
